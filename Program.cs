...
namespace Ease_FileDirectory
{
    class Program       
    {
        ...
        {
            EaseFileCompact BetaTest = new EaseFileCompact("Denis.txt");
            System.Console.WriteLine(string.Concat(BetaTest.GetListFiles()));

            Console.WriteLine("Hello World!");
             System.IO.DirectoryInfo yy = new System.IO.DirectoryInfo("Denis");
            if (yy.Exists == true)
            {
                //yy.Delete(true);
